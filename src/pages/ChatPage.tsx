...
export function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Error */}
      {error && (
        <div className="mx-4 mt-3 flex items-center gap-2 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-700 rounded-xl px-4 py-3 text-sm text-amber-800 dark:text-amber-300">
